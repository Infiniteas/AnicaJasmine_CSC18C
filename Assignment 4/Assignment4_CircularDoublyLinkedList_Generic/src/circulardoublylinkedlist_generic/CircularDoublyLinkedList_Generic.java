 ...
 * Date: 4/10/15
 *
 * Comments: I created a method that linked the first Link and the last Link in
 * the List. Otherwise, code is same a doubly linked list
 */
 ...
 * @param <T>
 */
public class CircularDoublyLinkedList_Generic<T> {
    ...
    //Constructor
    CircularDoublyLinkedList_Generic() {
        newestLink = null;
        headLink = null;
    }
    ...
    */
    ...
    public Link deleteNewestLink() {
        ...
        headLink.previous = newestLink;
        newestLink.next = headLink;
    ...
    public boolean insertAfter(T item, T itemInLinkedList){
        ...
        if (current == newestLink) {
            newLink.next = headLink; // newLink is the newestLink so no next available
    ...
    /**
     * This method makes the Doubly Linked List to a circular linked list 
     */
    public void connectHeadToNewestLink(){
        headLink.previous = newestLink;
        newestLink.next = headLink;
    }
    ...
    public void printLinkedList() {   
        ...
        do{ 
            ...
            System.out.println();
        } while(theLink.item != newestLink.next.item);
    }
}